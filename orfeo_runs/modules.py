...
# Import also a support vector machine (SVM), which is widely regarded as one of the best text 
# classification (and regression) algorithms (although it’s also a bit slower than naïve Bayes).
